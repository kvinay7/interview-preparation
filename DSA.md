...
An array is a linear data structure that can store fixed-size, sequential collections of elements of the same type in a single variable of contiguous memory locations. By default array elements are initialized to 0 if they are a numeric type ( int or double ), false if they are of type boolean , or null if they are an object type like String.
  ...
  - [Custom ArrayList Implementation](https://github.com/kvinay7/Practice-Kotlin-Fundamentals/blob/main/CustomArrayList.java)
  ...
  - **Problems:**
    ...
    - [Set Matrix Zeroes](https://github.com/AlgoMaster-io/leetcode-solutions/blob/main/java/set-matrix-zeroes.md)
---
...
| **[Example Usage](https://github.com/kvinay7/Practice-Kotlin-Fundamentals/blob/main/StringAndStringBuilderDemo.java)**       | `String s1 = "Hello";`, `String s2 = new String("ell");`| `StringBuilder sb = new StringBuilder("Hello");` | `StringBuffer sbf = new StringBuffer("Hello");` |
